...
base.prototype.clone = function (node) {
    if (!node) {
        node = this[0];
    }
    const ownerDocument = this.root()[0].ownerDocument;
    const newDocument = ownerDocument.implementation.createDocument(ownerDocument.namespaceURI, null, null);
...
//# sourceMappingURL=MathMLReader.js.map